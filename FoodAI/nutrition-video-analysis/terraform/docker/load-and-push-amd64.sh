...
echo "==========================================="
echo "Loading AMD64 Docker image from S3 and pushing to ECR"
echo "==========================================="
...
echo "Downloading and loading AMD64 image (this will take 10-15 minutes)..."
(
  for part in aa ab ac ad ae af ag ah ai aj ak; do
    aws s3 cp s3://${S3_BUCKET}/docker-images/amd64/video-processor-amd64-part-${part} - --region ${REGION}
  done
) | docker load
